...
import Analisis from '../pages/dashboard/analisis/appAna'
...
import AjustesApp from '../pages/dashboard/ajustes/AjustesApp'
...
import { resetData } from '../pages/dashboard/ajustes/AjustesApp'
    ...
    <>
      ...
      >
        {pinDiv == 0 ? (
                ...
                {[0, 1, 2, 3].map(i => (
                  <input
                    ...
                    className={`block w-1/5 border-2 bg-transparent ${
                      settings.tema == 'light'
                        ? `border-gray-200 text-text focus:shadow-[0px_0px_15px_${settings.color}]`
                        : `border-[#d1d5db50] text-textDark focus:shadow-[0px_0px_15px_${settings.color}]`
          ...
          <div className='relative flex flex-col items-center w-full h-full gap-5'>
            <button className='absolute flex items-center justify-center w-10 h-10 text-4xl rounded-full top-4 left-4' onClick={() => setPinDiv(0)}>
              <i className='fa-solid fa-arrow-left'></i>
            </button>
            <h1
      ...
      <div className='contenedor max-h-none max-w-none w-screen h-[calc(100vh-80px)] grid md:grid-cols-[auto_1fr] max-md:grid-cols-[1fr]'>
        ...
        >
          <div className='flex flex-col items-center w-full gap-10'>
            ...
            <nav className='left__nav h-fit w-[250px]'>
              <LeftLi
                aHref='/src/pages/dashboard/home/home.html'
                liInner={String(t('a.0'))}
                classLi='Resumen'
                iClass='fa-solid fa-chart-pie'
              ></LeftLi>
              <LeftLi
                aHref='/src/pages/dashboard/busqueda/busqueda.html'
                liInner={String(t('a.1'))}
                classLi='Búsqueda'
                iClass='fa-solid fa-search'
              ></LeftLi>
              <LeftLi
                aHref='/src/pages/dashboard/transactions/transactions.html'
                liInner={String(t('a.2'))}
                classLi='Transacciones'
                iClass='fa-solid fa-exchange-alt'
              ></LeftLi>
              <LeftLi
                aHref='/src/pages/dashboard/categorias/categorias.html'
                liInner={String(t('a.4'))}
                classLi='Categorias'
                iClass='fa-solid fa-folder'
              ></LeftLi>
              <LeftLi
                aHref='/src/pages/dashboard/otrasOpciones/otrasOpciones.html'
          ...
          <nav className='left__nav h-fit w-[250px]'>
            <LeftLi
              aHref='/src/pages/dashboard/ajustes/ajustes.html'
        ...
        >
          <Routes>
            <Route
              path='/src/pages/dashboard/home/home.html'
              element={
                <Home functionEdit={showEdit} functionDelete={showDelete} />
              }
            />
            <Route
              path='/src/pages/dashboard/busqueda/busqueda.html'
              element={
                <Search functionEdit={showEdit} functionDelete={showDelete} />
              }
            />
            <Route
              path='/src/pages/dashboard/transactions/transactions.html'
              element={
                <TransacctionsPage
            ...
            />
            <Route
              path='/src/pages/dashboard/categorias/categorias.html'
              element={<Categorias />}
            />
            <Route
              path='/src/pages/dashboard/analisis/analisis.html'
              element={<Analisis />}
            />
            <Route
              path='/src/pages/dashboard/ajustes/ajustes.html'
              element={<AjustesApp />}
            />
            <Route
              path='/src/pages/dashboard/otrasOpciones/otrasOpciones.html'
